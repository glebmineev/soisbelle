<g:applyLayout name="main">
  <tpl:useTemplate template="/template">
    ...
    <tpl:block name="wrap_content">
      <div class="info">
        <h1>Благодарим Вас за регистрацию в интернет-магазине «Sois belle»
        Регистрация прошла успешно. Письмо для подтверждения регистрации отправлено на Ваш электронный адрес
        </h1>
      </div>
    </tpl:block>
